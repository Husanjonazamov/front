...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-cyan-600 to-pink-500 items-center justify-center p-12 animate-in fade-in slide-in-from-right-4 duration-700">
